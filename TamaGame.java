...
class Tamagoshis {
    ...
    private static Tamagoshis[] pets;
...
class GrosMangeur extends Tamagoshis {
...
class GrosJoueur extends Tamagoshis {
...
public class TamaGame {
    ...
    public static void main(String[] args) {
        ...
        pets = new Tamagoshis[numPets];


        for (int i = 0; i < numPets; i++) {

            pets[i] = new Tamagoshis(NAMES[random.nextInt(NAMES.length)]);
